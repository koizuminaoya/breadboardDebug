...
\begin{figure}[ht]
  ...
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \includegraphics[width=45mm]{How2DMM.png}
    \caption*{デジタルマルチメータ\\使い方}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \includegraphics[width=45mm]{How2breadboard.png}
    \caption*{ブレッドボードの使い方\\【初心者向け】}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \includegraphics[width=45mm]{オシロスコープの基本的な使い方.png}
    \caption*{オシロスコープの\\基本的な使い方}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \includegraphics[width=45mm]{AWG電線のストリップ方法+コツの解説.png}
    \caption*{電線のストリップ方法\\コツの解説}
  \end{minipage}%
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
            \includegraphics[width=45mm]{テスターで回路の不具合を見つける方法.png}
            \caption*{テスターを用いた\\回路チェック手順}
    \end{minipage}%
    \hspace{2mm}% 
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \includegraphics[width=45mm]{はんだ付け手順.png}
        \caption*{はんだ付け手順\\初心者向け}
    \end{minipage}%
    \hspace{2mm}% 
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \includegraphics[width=45mm]{heatGun.png}%
        \caption*{熱収縮チューブの使い方\\　}
    \end{minipage}%
    \hspace{2mm}%  
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \includegraphics[width=45mm]{XHコネクタ 取り付け方・外し方.png}%
