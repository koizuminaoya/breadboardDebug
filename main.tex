...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=south east,
        ...
        \begin{minipage}{40mm}
            ...
            \includegraphics[width=40mm]{GitHub_breadboardDebug.png}
            }
            \vspace{1mm}
...
\begin{figure}[ht]
  ...
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://youtu.be/gUanuYbY0Lw?si=l7XW5_b5rN2pgpZA&t=170 external_link}{\includegraphics[width=45mm]{オシロスコープの基本的な使い方.png}}
    {\caption*{オシロスコープの\\基本的な使い方}}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://www.youtube.com/watch?v=Qmh3hsJoz24}{\includegraphics[width=45mm]{AWG電線のストリップ方法+コツの解説.png}}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://youtu.be/GylWvqeNnhs?si=J8i-75eDbgA28qz6}{\includegraphics[width=45mm]{テスターで回路の不具合を見つける方法.png}}
        \caption*{テスターを用いた\\回路チェック手順}
    \end{minipage}%
    \hspace{2mm}% 
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://youtu.be/D-R21fMsS5g}{\includegraphics[width=45mm]{はんだ付け手順.png}}
