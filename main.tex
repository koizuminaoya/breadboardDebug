...
\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=south east,
        xshift= -20mm,
        yshift=  20mm] at (current page.south east)
        {
        \begin{minipage}{40mm}
            \centering
            \href{https://github.com/koizuminaoya/breadboardDebug}{
            \includegraphics[width=40mm]{img/GitHub_breadboardDebug.png}
            }
            \vspace{1mm}
            {\footnotesize 本資料のリポジトリ\\GitHub}
        \end{minipage}
        };
\end{tikzpicture}
...
\begin{figure}[ht]
  ...
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://www.youtube.com/watch?v=Oiyc06vAxoM}{\includegraphics[width=45mm]{img/How2DMM.png}}
    \caption*{デジタルマルチメータ\\使い方}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://www.youtube.com/watch?v=hST5hSvnf_o}{\includegraphics[width=45mm]{img/How2breadboard.png}}
    \caption*{ブレッドボードの使い方\\【初心者向け】}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://youtu.be/gUanuYbY0Lw?si=l7XW5_b5rN2pgpZA&t=170 external_link}{\includegraphics[width=45mm]{img/how2oscilloscope.png}}
    {\caption*{オシロスコープの\\基本的な使い方}}
  \end{minipage}%
  \hspace{2mm}%
  \begin{minipage}[b]{0.24\columnwidth}
    \centering
    \href{https://www.youtube.com/watch?v=Qmh3hsJoz24}{\includegraphics[width=45mm]{img/wirestripper.png}}
...
\begin{figure}[ht]
    ...
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://youtu.be/GylWvqeNnhs?si=J8i-75eDbgA28qz6}{\includegraphics[width=45mm]{img/debug_w_DMM.png}}
        \caption*{テスターを用いた\\回路チェック手順}
    \end{minipage}%
    \hspace{2mm}% 
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://youtu.be/D-R21fMsS5g}{\includegraphics[width=45mm]{img/soldering.png}}
        \caption*{はんだ付け手順\\初心者向け}
    \end{minipage}%
    \hspace{2mm}% 
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://youtu.be/NBAlvphDdOs?si=4FJ-Rjs8-pynXgfv}{\includegraphics[width=45mm]{img/heatGun.png}}%
        \caption*{熱収縮チューブの\\使い方}
    \end{minipage}%
    \hspace{2mm}%  
    \begin{minipage}[b]{0.24\columnwidth}
        \centering
        \href{https://www.youtube.com/watch?v=-CE_2HUecYM}{\includegraphics[width=45mm]{img/how2connector.png}}%
